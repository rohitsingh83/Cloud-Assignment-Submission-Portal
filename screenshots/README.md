...
- **Direct Image File**: [**`architecture_diagram.png`**](./architecture_diagram.png) *(1200 × 740 px)*
- **Markdown Embed**: `![Architecture](./screenshots/architecture_diagram.png)`

<p align="center">
  <img src="architecture_diagram.png" alt="Architecture Diagram" width="95%"/>
</p>
...
- **Direct Image File**: [**`dashboard_preview.png`**](./dashboard_preview.png) *(1100 × 680 px)*
- **Markdown Embed**: `![Dashboard](./screenshots/dashboard_preview.png)`

<p align="center">
  <img src="dashboard_preview.png" alt="Dashboard Preview" width="95%"/>
</p>
...
- **Direct Image File**: [**`login_portal_preview.png`**](./login_portal_preview.png) *(1200 × 800 px)*
- **Markdown Embed**: `![Login Portal](./screenshots/login_portal_preview.png)`

<p align="center">
  <img src="login_portal_preview.png" alt="Login Portal Preview" width="85%"/>
</p>
...
- **Direct Image File**: [**`grading_evaluation_preview.png`**](./grading_evaluation_preview.png) *(1200 × 800 px)*
- **Markdown Embed**: `![Grading Evaluation](./screenshots/grading_evaluation_preview.png)`

<p align="center">
  <img src="grading_evaluation_preview.png" alt="Grading Evaluation Preview" width="85%"/>
</p>
...
- **Direct Image File**: [**`submission_flow.png`**](./submission_flow.png) *(1100 × 520 px)*
- **Markdown Embed**: `![Submission Flow](./screenshots/submission_flow.png)`

<p align="center">
  <img src="submission_flow.png" alt="Submission Flow" width="95%"/>
</p>
...
- **Direct Image File**: [**`plagiarism_scanner_preview.png`**](./plagiarism_scanner_preview.png) *(900 × 560 px)*
- **Markdown Embed**: `![Similarity Scanner](./screenshots/plagiarism_scanner_preview.png)`

<p align="center">
  <img src="plagiarism_scanner_preview.png" alt="Plagiarism Scanner" width="85%"/>
</p>
...
- **Direct Image File**: [**`file_preview_modal.png`**](./file_preview_modal.png) *(1200 × 800 px)*
- **Markdown Embed**: `![File Preview](./screenshots/file_preview_modal.png)`

<p align="center">
  <img src="file_preview_modal.png" alt="File Preview Modal" width="85%"/>
</p>
